...
import ink.bgp.hcloader.data.RandomAccessData;
import ink.bgp.hcloader.data.RandomAccessDataFile;
...
public class JarFile extends AbstractJarFile implements Iterable<java.util.jar.JarEntry> {
	...
	private static final String HANDLERS_PACKAGE = "ink.bgp.asteroid.loader";
